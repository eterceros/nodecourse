...
function handle_get_album(req, res) {
    ...
    load_album(album_name,page, page_size, function (err, photos) {
        ...
        res.writeHead(200, {"Content-Type": "application/json"});
        res.end(JSON.stringify({"error": null, "data": {albums: {album_name: album_name, photos: photos}}}) + "\n");
...
/*
 ...
 curl -i -X GET http://localhost:8080/albums.json
 curl -i -X GET http://localhost:8080/albums/italy2012.json
 curl -i -X GET http://localhost:8080/albums/italy2012.json?page=0&page_size=20
 */


/*
 in case of fail use the pattern
 ...
 in case of success use the pattern:
 {
 error: null,
 data:{user: "edson", name: "edson", email_address:"edson@gmail.com"}
 }
